...
namespace Zamin.Utilities.Serilog.Registration.Enrichers;
public class ZaminApplicaitonEnricher(IOptions<SerilogApplicationEnricherOptions> options) : ILogEventEnricher
{
    private readonly SerilogApplicationEnricherOptions _options = options.Value;
