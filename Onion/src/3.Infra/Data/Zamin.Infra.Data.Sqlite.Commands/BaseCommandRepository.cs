...
public class BaseCommandRepository<TEntity, TDbContext, TId>(TDbContext dbContext) : ICommandRepository<TEntity, TId>, IUnitOfWork
...
public class BaseCommandRepository<TEntity, TDbContext>(TDbContext dbContext) : BaseCommandRepository<TEntity, TDbContext, long>(dbContext)
